...
def mock_transactions_df():
    return [
        {
            "Номер карты": "*3456",
            "Сумма операции": -1234.0,
            "Дата операции": "17.06.2025 10:00:00",
        },
        {
            "Номер карты": "*3456",
            "Сумма операции": -578.0,
            "Дата операции": "18.06.2025 12:00:00",
        },
        {
            "Номер карты": "*7654",
            "Сумма операции": -222.0,
            "Дата операции": "19.06.2025 14:00:00",
        },
        {
            "Номер карты": "*7654",
            "Сумма операции": -320.0,
            "Дата операции": "20.06.2025 16:00:00",
        },
    ]
